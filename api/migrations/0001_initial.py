# Generated by Django 5.1.1 on 2024-09-27 23:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_basura', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.tipobasura')),
            ],
        ),
        migrations.CreateModel(
            name='Usuario',
            fields=[
                ...
                ('telefono', models.CharField(max_length=15, unique=True, validators=[api.models.validar_telefono])),
